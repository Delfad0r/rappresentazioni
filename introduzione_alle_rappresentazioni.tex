...
\begin{definition}
Siano $\Rep{\rho}{G}{V}\comma\Rep{\sigma}{G}{W}$ rappresentazioni. Si definisce \emph{somma} di $\rho$ e $\sigma$ la rappresentazione $\Rep{\rho+\sigma}{G}{V\dirsum W}$ tale che per ogni $g\in G\comma v\in V\comma w\in W$ vale
$$
(\rho+\sigma)(g)(v\dirsum w)=\rho(g)v\dirsum\sigma(g)w
$$
\end{definition}
...
\begin{definition}
Sia $G$ un gruppo. Consideriamo l'azione $\varphi:G\to \Sym(G)$ della moltiplicazione a sinistra, ossia $\varphi(g)=(x\mapsto gx)$ per ogni $g\in G$. Si chiama \emph{rappresentazione regolare} di $G$ la rappresentazione per permutazione di $G$ su se stesso $\Rep{\mathcal{R}}{G}{\mathbb{K}[G]}$.
\end{definition}
...
Siano $G\comma H$ gruppi finiti. Supponiamo $\mathbb{K}$ algebricamente chiuso. Allora
$$
