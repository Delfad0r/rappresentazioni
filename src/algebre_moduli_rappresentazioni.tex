\chapter{Algebre, Moduli, Rappresentazioni}
...
\end{corollary}
\begin{proof}
È sufficiente ricordare la \thref{division-algebra-closed-fields} e applicare il teorema di Wedderburn.
\end{proof}


\begin{corollary}\thlabel{algebra-semisimple-left-right}
...
\begin{proposition}[Teorema di Maschke]\thlabel{maschke-theorem}
...
Possiamo ora dare una dimostrazione alternativa della \thref{representation-finite-completely-reducible}.
\representationfinitecompletelyreducible*
\begin{proof}
Per il teorema di Maschke $\mathbb{K}[G]$ è semisemplice, dunque per la \thref{modules-on-semisimple-algebra} ogni $\mathbb{K}[G]$-modulo sinistro (non nullo) è semisemplice, il che è equivalente a dire che ogni rappresentazione di $G$ è completamente riducibile.
\end{proof}


La \thref{module-schur-lemma} e il \thref{module-schur-lemma-2} possono essere interpretate rispettivamente come lemma di Schur I e lemma di Schur II.


\begin{corollary}\thlabel{group-algebra-decomposition}
...
$$
dove $D_i=\End^{\op}_{\mathbb{K}[G]}(V_i)$. Per il lemma di Schur (\thref{module-schur-lemma-2}), $D_1=\mathbb{K}$, dunque
$$
