...
\begin{definition}
Siano $\Rep{\rho}{G}{V}\comma\Rep{\sigma}{G}{W}$ rappresentazioni. Un'applicazione lineare $\varphi:V\to W$ si dice \emph{isomorfismo di rappresentazioni} se è un isomorfismo di spazi vettoriali e un omomorfismo di rappresentazioni. Diciamo che $\rho$ e $\sigma$ sono \emph{isomorfe} (e scriviamo $\rho\isor\sigma$ o, più liberamente, $\rho=\sigma$) se esiste un isomorfismo di rappresentazioni da $\rho$ in $\sigma$.
\end{definition}
...
\begin{proposition}\thlabel{representation-quotient}
...
\begin{proposition}\thlabel{representation-quotient-universal}
...
\begin{corollary}[Teorema di Omomorfismo]\thlabel{representation-quotient-hom-theorem}
...
\end{corollary}
\begin{proof}
La tesi segue immediatamente dalla \thref{representation-quotient-universal} e dal teorema di omomorfismo per spazi vettoriali.
\end{proof}
...
\begin{restatable}{proposition}{representationfinitecompletelyreducible}\label{representationfinitecompletelyreducible}\thlabel{representation-finite-completely-reducible}
...
Poiché il lemma di Schur II è alla base dei risultati seguenti, fino alla fine di questa sezione (\thref{representation-decomposition-subrepresentation-uniqueness}) supporremo sempre che le rappresentazioni siano di grado finito e che $\mathbb{K}$ sia algebricamente chiuso.
...
\end{corollary}
\begin{proof}
La tesi segue immediatamente dalla \thref{representation-decomposition-formula} e dalla \thref{representation-regular-homomorphisms-dim}, dopo aver osservato che le ipotesi implicano la completa riducibilità di $\mathcal{R}$.
\end{proof}
...
\begin{proposition}\thlabel{representation-fix-of-homomorphisms}
