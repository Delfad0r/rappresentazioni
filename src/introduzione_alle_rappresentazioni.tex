...
Sia $\Rep{\rho}{G}{V}$ una rappresentazione, $W\subseteq V$ un sottospazio $G$-stabile, $\pi:V\to V/W$ la proiezione, $\Rep{\bar\rho}{G}{V/W}$ la rappresentazione quoziente. Sia $\Rep{\sigma}{G}{Z}$ una rappresentazione, $\varphi\in\Hom(\rho,\sigma)$ un omomorfismo. Allora esiste un'unica applicazione $\bar\varphi\in\Hom(\bar\rho,\sigma)$ che fa commutare il diagramma
$$
\begin{diagram}
